<template>
  <div class="mx-auto mt-2 mb-8">
    <h2 class="flex items-center text-lg font-medium text-black">
      <ClipboardDocumentCheckIcon class="h-6 w-6 mr-2"/> Histori Daftar
    </h2>
              ...
              <div class="flex items-center justify-between">
                <div class="text-xs mt-1">
                  <div class="flex items-center">
                    Antrian Nomor: {{ item.posisi??'Belum Tersedia' }}
                  </div>
                  <!-- <div class="flex items-center">
                    {{ item.ref_nomor }}
                  </div> -->
                ...
                <div class="ml-2 flex flex-shrink-0">
                  <p v-if="item.status === 'P'" class="inline-flex rounded-full bg-yellow-100 px-2 text-sm font-semibold leading-5 text-yellow-800">Proses</p>
                  <p v-if="item.status === 'Q'" class="inline-flex rounded-full bg-blue-100 px-2 text-sm font-semibold leading-5 text-blue-800">Antri</p>
