    ...
    <div class="bg-white p-4 rounded-md mt-4">
      <div>
        ...
        <div class="mt-2">
          <vueNumberFormat
            readonly
            v-model:value="auth.saldo"
            type="text"
            autocomplete="first_name"
            required="true"
            class="block w-full text-xl bg-gray-200 text-right appearance-none rounded-md border border-gray-300 px-3 py-2 placeholder-slate-400 shadow-sm focus:border-slate-400 focus:outline-none focus:ring-sky-400 text-xs"
          />
        </div>
      </div>
      ...
      <div class="bg-yellow-400 p-4 rounded-sm mt-4 text-sm">
        <div class="flex justify-start">
          ...
          <div class="w-full">
            Withdrawel dapat dilakukan minimal sebesar Rp.50.000 berlaku
            kelipatan.
          </div>
        </div>
      </div>
                ...
                <form @submit.prevent="withdrawn()" method="post">
                  <div class="">
                    ...
                    <vueNumberFormat
                      ...
                      autocomplete="first_name"
                      class="block w-full text-sm text-right appearance-none rounded-md border border-gray-300 px-3 py-2 placeholder-slate-400 shadow-sm focus:border-slate-400 focus:outline-none focus:ring-sky-400 text-xs"
                    />
                  </div>
